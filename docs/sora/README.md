---
title: chatgpt直播发布第3天：chatgpt正式上线Sora，Sora是什么？如何使用？详细教程
description: 2024年2月16日chatgpt 在其官网上面正式宣布推出文本生成视频的大模型Sora，在我们等了298天的Sora，终于， chatgpt直播发布第3天，Sora2024年12月9日正式上线了
meta: 
  - 
    name: description
    content: 2024年2月16日 chatgpt 在其官网上面正式宣布推出文本生成视频的大模型Sora，在我们等了298天的Sora，终于， chatgpt直播发布第3天，Sora2024年12月9日正式上线了
  - 
    name: keywords
    content: Sora如何使用
tags: 
...
categories: 
  - ChatGPT升级
date: 2024-12-10 22:48:43
---

# chatgpt直播发布第3天：chatgpt正式上线Sora，Sora是什么？如何使用？详细教程
## Sora 是什么？
2024年2月16日，chatgpt 在其官网上面正式宣布推出文本生成视频的大模型Sora


在我们等了298天的Sora，终于， chatgpt直播发布第3天，Sora2024年12月9日正式上线了。而且不仅仅是一个模型，而是一个非常完善且体验极佳的真正的产品。


12月9日，在chatgpt第3场直播发布中，文生视频模型Sora正式发布！在今天的demo中，chatgpt团队确认了目前的Sora支持文字、图像和视频三种内容作为生成视频的输入材料，用户可主动调节横竖屏（尺寸）、清晰度、视频时长等多个参数。

![](https://hlplch.aliyuntm.com/chatgpt/WechatIMG945.jpg)

## 会员特权与体验模式

地址：[Sora地址](https://sora.com),从今天起，ChatGPT Plus和Pro会员即可开始体验Sora模型！
...
PS：国内想升级ChatGPT Plus和Pro会员微信和支付宝都不能直接使用，信用卡借记卡都不行，只能使用国外的虚拟卡，推荐本人一直使用的WildCard平台，很靠谱和专业: [WildCard地址 | 一分钟开卡，轻松订阅海外软件服务](https://chongzhi.aliyuncn.com/)  邀请码 **GPT310**，有开卡优惠，虚拟卡开好之后，用支付宝充值使用。

2025年7月25更新，现阶段 Wildcard 野卡，不能充值，不能提现，不能注册，平替方案给自己ChatGPT账号充值,国内靠谱的chatgpt自助订阅系统可以直接充值，限时优惠详情：[https://chongzhi.aliyuncn.com/](https://chongzhi.aliyuncn.com/)


## Sora主要技术难点

Sora背后接入的是一个新模型，Sora Turbo，推理成本肯定少了非常非常多，这也解释了为啥chatgpt把Sora拖了这么久，就是因为二月份的那个模型，推理起来太烧钱了，跑不动。
...
[https://cdn.chatgpt.com/sora/videos/cat-on-bed.mp4](https://cdn.chatgpt.com/sora/videos/cat-on-bed.mp4)
...
[https://cdn.chatgpt.com/sora/videos/tokyo-in-the-snow.mp4](https://cdn.chatgpt.com/sora/videos/tokyo-in-the-snow.mp4)
...
[https://cdn.chatgpt.com/sora/videos/snow-dogs.mp4](https://cdn.chatgpt.com/sora/videos/snow-dogs.mp4)

提示词：一窝金毛幼犬在雪地里玩耍。他们的头从雪中探出来，被雪覆盖着。

[https://cdn.chatgpt.com/sora/videos/robot-video-game.mp4](https://cdn.chatgpt.com/sora/videos/robot-video-game.mp4)
...
[https://cdn.chatgpt.com/sora/videos/backward-jogger.mp4](https://cdn.chatgpt.com/sora/videos/backward-jogger.mp4)
...
[https://cdn.chatgpt.com/sora/videos/puppy-cloning.mp4](https://cdn.chatgpt.com/sora/videos/puppy-cloning.mp4)
...
[https://cdn.chatgpt.com/sora/videos/basketball-explosion.mp4](https://cdn.chatgpt.com/sora/videos/basketball-explosion.mp4)

提示词：篮球穿过篮筐然后爆炸。提示：篮球穿过篮筐然后爆炸。
弱点：不准确的物理建模和不自然的物体“变形”的例子。

[https://cdn.chatgpt.com/sora/videos/chair-archaeology.mp4](https://cdn.chatgpt.com/sora/videos/chair-archaeology.mp4)

提示词：考古学家在沙漠中发现了一把普通的塑料椅子，他们小心翼翼地挖掘并除尘。提示：考古学家在沙漠中发现了一把普通的塑料椅子，他们小心翼翼地挖掘并除尘。
弱点：在这个例子中，Sora 未能将椅子建模为刚性物体，导致物理交互不准确。

[https://cdn.chatgpt.com/sora/videos/grandma-birthday.mp4](https://cdn.chatgpt.com/sora/videos/grandma-birthday.mp4)
...
国内想升级ChatGPT Plus和Pro会员微信和支付宝都不能直接使用，信用卡借记卡都不行，智能使用国外的虚拟卡，推荐本人一直使用的WildCard平台，很靠谱和专业: [WildCard地址 | 一分钟开卡，轻松订阅海外软件服务](https://chongzhi.aliyuncn.com/)  邀请码 **GPT310**，有开卡优惠，虚拟卡开好之后，用支付宝充值使用。

几分钟搞定安全可靠，本人的ChatGpt就是这么升级上来的！！！

### 使用Sora前的准备工作
在开始之前，确保您已经拥有了chatgpt账目，并获得了Sora的访问权限。准备好您想要转化成视频的文本描述，记住越详细越好。

### Sora使用步骤一：文本描述
登录您的chatgpt账户，找到Sora的使用界面。在指定区域输入您的文本描述，可以是一个故事概述、场景描述或是具体的动作指令。

### Sora使用步骤二：生成视频
完成文本描述和自定义设置后，点击“生成视频”按钮。Sora将开始处理您的请求，这可能需要几分钟时间。完成后，您可以预览生成的视频。

**需要注意的是，截止2024年2月28日，chatgpt只向部分专业用户开放了Sora的访问权限。普通用户只能观看其发布的演示视频。**

## chatgpt sora如何使用的常见问答Q&A
### 问题：Sora是什么？
- Sora是由chatgpt开发的AI视频生成模型。
- Sora可以根据用户提供的描述性文字生成长达60秒的高质量视频。
- Sora的视频包含精细复杂的场景、生动的角色表情和复杂的镜头运动。

### 问题：Sora怎么使用？
- 登录chatgpt账户并找到Sora的使用界面。
- 在指定区域输入您的文本描述，可以是一个故事概述、场景描述或是具体的动作指令。
- 点击生成按钮，chatgpt Sora会根据您的文本描述生成视频。
