...
1. 模型线升级成 GPT-5.1 Instant、GPT-5.1 Thinking，两条线各自往前推。
2. 更重视对话体验：风格预设、自定义语气、多轮不“失忆”、更接近自然聊天。
...
1. 现在背后默认是 GPT-5.1 系列，你可能已经在用它了。
2. Auto 会自动帮你选用 Instant 还是 Thinking。
3. 风格预设 + 个性化设置，是这次最大可感的提升。
4. 自定义指令更稳定，不容易“忘设定”。
5. 心理健康与情感依赖变成重点安全指标。
6. 群聊目前只在少数地区试点，但方向已经很明确。
