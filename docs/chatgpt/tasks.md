...
**ChatGPT Tasks**是一个未来的“定时任务助手”，能让你的ChatGPT在未来某个时间点执行你设定的任务。

与苹果Siri、谷歌Assistant、亚马逊Alexa这些语音助手不同，Tasks由强大的GPT-4o模型驱动，更聪明、更强大！

### 举个例子：

- ⏰ 定时提醒你“该健身了”，并温馨提示你做好热身。
- ☀️ 每天早上8点为你播报天气，并提供穿衣建议。
- 📰 每天7点推送全球最新AI新闻。
- 📅 每周五整理你的周报并发送给你。
...
![](https://hlplch.aliyuntm.com/chatgpt/WechatIMG1001.jpg)

ChatGPT属于第一阶段，已发布的推理模型o1和即将发布的o3属于第二阶段。而ChatGPT Tasks，已初具**第三阶段：智能体（Agents）** 的雏形。
...
1. ChatGPT页面左上角的模型选择菜单，选择“GPT-4o with scheduled tasks”。
2. 右上角头像设置中，新增的“Tasks”菜单。

![](https://hlplch.aliyuntm.com/chatgpt/WechatIMG1003.jpg)

### 设置方法：

只需通过对话即可设置。例如：

> 每天早上10点发我最新最炸裂的全球AI新闻。

设置成功后，你会看到一个任务卡片。点击右侧三个点，可进行编辑（Edit）、**暂停（Pause）和查看全部任务（View all tasks）** 等操作。

你还可以通过对话直接更新任务，支持中文。例如：
...
目前Tasks功能仍在beta测试阶段，存在一些限制：

- 仅支持Web、iOS、Android和MacOS，Windows版将在今年第一季度推出。
- 每个账户最多可创建10个任务。
