...
用银行卡支付提示「银行卡被拒绝/card has been declined」，也用过visa等信用卡购买时提示「chatgpt的系统拒绝了他们的信用卡，建议改用借记卡支付」

然后偶然间在朋友圈看到小bei的分享，然后点进去发现是一个专门国内做虚拟信用卡的平台，然后无脑注册，充值了$20美元然后就丝滑般的升级成功了，很是意外，现在记录下注册升级过程。

需要代充的朋友请访问以下地址，野卡复活之后和代充走的一样的逻辑，且代充相对比野卡便宜。
...
登录ChatGPT后，在同一浏览器新开一个标签页，点击以下链接即可进入升级页面： **[https://chat.chatgpt.com/invite/accepted](https://chat.chatgpt.com/invite/accepted)**
